...
public class FetchBindingResponse extends OpenServiceBrokerResponse {
	...
	public static class FetchBindingResponseBuilder {
		...
		public FetchBindingResponseBuilder() {
		}

		public FetchBindingResponseBuilder body(FetchBindingResponseBody body) {
			this.body = body;
			return this;
		}
		...
		public FetchBindingResponse build() {
			...
			FetchBindingResponse result = new FetchBindingResponse(this);
			return result;
		}
	}

	private FetchBindingResponse(FetchBindingResponseBuilder builder) {
		statusCode = 200;
		body = builder.body;
	}
