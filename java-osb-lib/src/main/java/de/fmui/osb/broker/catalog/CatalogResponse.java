...
public class CatalogResponse extends OpenServiceBrokerResponse {
	...
	public static class CatalogResponseBuilder {
		...
		public CatalogResponseBuilder() {
		}

		public CatalogResponseBuilder body(CatalogResponseBody body) {
			this.body = body;
			return this;
		}
		...
		public CatalogResponse build() {
			...
			CatalogResponse result = new CatalogResponse(this);
			return result;
		}
	}

	private CatalogResponse(CatalogResponseBuilder builder) {
		statusCode = 200;
		body = builder.body;
	}
